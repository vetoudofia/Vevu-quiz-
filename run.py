...
CORS(app, origins=[
    ...
    "https://ekxuxyoxcvaatluhqhhr.supabase.co"  # Your Supabase URL
...
if __name__ == '__main__':
    print("=" * 60)
    print("🎉 VEV QUIZER BACKEND - READY FOR DEPLOYMENT!")
    print("=" * 60)
    print(f"\n📁 Configuration:")
    ...
    print(f"   • Quiz: http://localhost:5000/api/quiz")
    print(f"   • Wallet: http://localhost:5000/api/wallet")
    print(f"   • Spin Wheel: http://localhost:5000/api/wheel")
    print(f"   • Admin: http://localhost:5000/api/admin")
    print(f"\n🚀 Starting server...\n")
